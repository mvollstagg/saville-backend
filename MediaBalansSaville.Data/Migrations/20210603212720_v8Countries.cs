...
{
    public partial class v8Countries : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "az", true, false, "Azərbaycan", new DateTime(2021, 6, 4, 0, 27, 17, 707, DateTimeKind.Local).AddTicks(30), "az", 1 },
                    { 2, "ru", true, false, "Rusiya", new DateTime(2021, 6, 4, 0, 27, 17, 730, DateTimeKind.Local).AddTicks(9190), "ru", 2 },
                    { 3, "en", true, false, "İngiltərə", new DateTime(2021, 6, 4, 0, 27, 17, 730, DateTimeKind.Local).AddTicks(9230), "en", 3 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 2, true, false, "user", new DateTime(2021, 6, 4, 0, 27, 17, 746, DateTimeKind.Local).AddTicks(6570), "user", 2 },
                    { 1, true, false, "admin", new DateTime(2021, 6, 4, 0, 27, 17, 746, DateTimeKind.Local).AddTicks(5920), "admin", 1 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "admin@admin.com", "Admin", true, false, "Admin", "63a2fc904cc17426f994b55213d1726f2c5866b8bcd961b60ddf84aefea10aeb53727599338a4f1780a39d8396c2f877d90f28a397f793a7de319cfa6941c75d", "0534 895 22 84", new DateTime(2021, 6, 4, 0, 27, 17, 740, DateTimeKind.Local).AddTicks(910), "25f18e7132ef4b2580714b24413941c56/4/2021122717AM", null, 0 });
