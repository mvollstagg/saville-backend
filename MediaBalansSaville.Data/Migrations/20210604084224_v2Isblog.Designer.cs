...
namespace MediaBalansSaville.Data.Migrations
{
    ...
    [Migration("20210604084224_v2Isblog")]
    partial class v2Isblog
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MediaBalansSaville.Entities.Lang", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsDeleted = false,
                            Name = "Azərbaycan",
                            RecordedAtDate = new DateTime(2021, 6, 4, 11, 42, 23, 560, DateTimeKind.Local).AddTicks(3370),
                            SlugUrl = "az",
                            UrlId = 1
                        },
                        new
                        {
                            ...
                            IsDeleted = false,
                            Name = "Rusiya",
                            RecordedAtDate = new DateTime(2021, 6, 4, 11, 42, 23, 568, DateTimeKind.Local).AddTicks(3890),
                            SlugUrl = "ru",
                            UrlId = 2
                        },
                        new
                        {
                            ...
                            IsDeleted = false,
                            Name = "İngiltərə",
                            RecordedAtDate = new DateTime(2021, 6, 4, 11, 42, 23, 568, DateTimeKind.Local).AddTicks(3940),
                            SlugUrl = "en",
                            UrlId = 3
                        });
                });
            ...
            modelBuilder.Entity("MediaBalansSaville.Entities.ReceiptProduct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MediaBalansSaville.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsDeleted = false,
                            Name = "admin",
                            RecordedAtDate = new DateTime(2021, 6, 4, 11, 42, 23, 575, DateTimeKind.Local).AddTicks(5500),
                            SlugUrl = "admin",
                            UrlId = 1
                        },
                        new
                        {
                            ...
                            IsDeleted = false,
                            Name = "user",
                            RecordedAtDate = new DateTime(2021, 6, 4, 11, 42, 23, 575, DateTimeKind.Local).AddTicks(6140),
                            SlugUrl = "user",
                            UrlId = 2
                        });
                });
            ...
            modelBuilder.Entity("MediaBalansSaville.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsDeleted = false,
                            LastName = "Admin",
                            PasswordHash = "039c2d87f5e50b52fa10e9bb758b156a0c78b15ab8de5fa8f1da9048007ec66055386bf623acdba4708653ee28e26f8c57b42e94f777556c53e5c3ebce7c0b7c",
                            PhoneNumber = "0534 895 22 84",
                            RecordedAtDate = new DateTime(2021, 6, 4, 11, 42, 23, 570, DateTimeKind.Local).AddTicks(8180),
                            SecretKey = "470c59c6c7554b69b5bc3d816c99da286/4/2021114223AM",
                            UrlId = 0
                        });
                });
            ...
            modelBuilder.Entity("MediaBalansSaville.Entities.Product", b =>
                {
                    ...
                    b.HasOne("MediaBalansSaville.Entities.ReceiptProduct", null)
                        .WithMany("Products")
                        .HasForeignKey("ReceiptProductId");
