...
namespace MediaBalansSaville.Data.Migrations
{
    ...
    [Migration("20210530170029_v2CAT")]
    partial class v2CAT
    {
            ...
            modelBuilder.Entity("MediaBalansSaville.Entities.Lang", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsDeleted = false,
                            Name = "Azərbaycan",
                            RecordedAtDate = new DateTime(2021, 5, 30, 20, 0, 28, 89, DateTimeKind.Local).AddTicks(3860),
                            SlugUrl = "az",
                            UrlId = 1
                        },
                        new
                        {
                            ...
                            IsDeleted = false,
                            Name = "Rusiya",
                            RecordedAtDate = new DateTime(2021, 5, 30, 20, 0, 28, 98, DateTimeKind.Local).AddTicks(4250),
                            SlugUrl = "ru",
                            UrlId = 2
                        },
                        new
                        {
                            ...
                            IsDeleted = false,
                            Name = "İngiltərə",
                            RecordedAtDate = new DateTime(2021, 5, 30, 20, 0, 28, 98, DateTimeKind.Local).AddTicks(4310),
                            SlugUrl = "en",
                            UrlId = 3
                        });
                });
            ...
            modelBuilder.Entity("MediaBalansSaville.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsDeleted = false,
                            Name = "admin",
                            RecordedAtDate = new DateTime(2021, 5, 30, 20, 0, 28, 105, DateTimeKind.Local).AddTicks(9650),
                            SlugUrl = "admin",
                            UrlId = 1
                        },
                        new
                        {
                            ...
                            IsDeleted = false,
                            Name = "user",
                            RecordedAtDate = new DateTime(2021, 5, 30, 20, 0, 28, 106, DateTimeKind.Local).AddTicks(270),
                            SlugUrl = "user",
                            UrlId = 2
                        });
                });
            ...
            modelBuilder.Entity("MediaBalansSaville.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsDeleted = false,
                            LastName = "Admin",
                            PasswordHash = "5324e9a652c5e238c56e6420e69ac86aae5e97055a1895622d7d61e254407d81849bb2c16ef7ffa48600ef95b9faee07a6e21c3744261fc5643e6089150c13f3",
                            PhoneNumber = "0534 895 22 84",
                            RecordedAtDate = new DateTime(2021, 5, 30, 20, 0, 28, 100, DateTimeKind.Local).AddTicks(9550),
                            SecretKey = "b5fefe3b6af7446086bde1b9b8152bfd5/30/202180028PM",
                            UrlId = 0
                        });
                });
