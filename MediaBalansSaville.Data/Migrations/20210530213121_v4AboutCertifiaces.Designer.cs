...
namespace MediaBalansSaville.Data.Migrations
{
    ...
    [Migration("20210530213121_v4AboutCertifiaces")]
    partial class v4AboutCertifiaces
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MediaBalansSaville.Entities.Lang", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsDeleted = false,
                            Name = "Azərbaycan",
                            RecordedAtDate = new DateTime(2021, 5, 31, 0, 31, 20, 329, DateTimeKind.Local).AddTicks(9870),
                            SlugUrl = "az",
                            UrlId = 1
                        },
                        new
                        {
                            ...
                            IsDeleted = false,
                            Name = "Rusiya",
                            RecordedAtDate = new DateTime(2021, 5, 31, 0, 31, 20, 337, DateTimeKind.Local).AddTicks(8690),
                            SlugUrl = "ru",
                            UrlId = 2
                        },
                        new
                        {
                            ...
                            IsDeleted = false,
                            Name = "İngiltərə",
                            RecordedAtDate = new DateTime(2021, 5, 31, 0, 31, 20, 337, DateTimeKind.Local).AddTicks(8710),
                            SlugUrl = "en",
                            UrlId = 3
                        });
                });
            ...
            modelBuilder.Entity("MediaBalansSaville.Entities.Product", b =>
                {
                    ...
                    b.Property<string>("NutritionFactsPhotoUrl")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("MediaBalansSaville.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsDeleted = false,
                            Name = "admin",
                            RecordedAtDate = new DateTime(2021, 5, 31, 0, 31, 20, 344, DateTimeKind.Local).AddTicks(8910),
                            SlugUrl = "admin",
                            UrlId = 1
                        },
                        new
                        {
                            ...
                            IsDeleted = false,
                            Name = "user",
                            RecordedAtDate = new DateTime(2021, 5, 31, 0, 31, 20, 344, DateTimeKind.Local).AddTicks(9540),
                            SlugUrl = "user",
                            UrlId = 2
                        });
                });
            ...
            modelBuilder.Entity("MediaBalansSaville.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsDeleted = false,
                            LastName = "Admin",
                            PasswordHash = "ddba7a229e569c4b28f7e0dc8565dccd74d6e1f7dc03d35bbda6b38b77105d336f7c6627a0c47c88683feaef4c2cc3da0a18023d0583114ae12f32784c32e1df",
                            PhoneNumber = "0534 895 22 84",
                            RecordedAtDate = new DateTime(2021, 5, 31, 0, 31, 20, 340, DateTimeKind.Local).AddTicks(970),
                            SecretKey = "cb780f2724e243da84fcb75dcf87af5d5/31/2021123120AM",
                            UrlId = 0
                        });
                });
            ...
            modelBuilder.Entity("MediaBalansSaville.Entities.AboutSettingsItem", b =>
                {
                    b.HasOne("MediaBalansSaville.Entities.AboutSettings", null)
            ...
            modelBuilder.Entity("MediaBalansSaville.Entities.AboutSettingsItemLang", b =>
                {
                    ...
                    b.HasOne("MediaBalansSaville.Entities.AboutSettingsItem", null)
